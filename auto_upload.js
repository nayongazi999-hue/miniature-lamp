...
// ⛔ অটো-আপলোড বন্ধ/চালু করার সুইচ — আপাতত false (বন্ধ)।
// আবার চালু করতে চাইলে শুধু নিচের লাইনে false থেকে true করে দিন।
const AUTO_UPLOAD_ENABLED = false;
...
async function main() {
  if (!AUTO_UPLOAD_ENABLED) {
    console.log('⛔ AUTO_UPLOAD_ENABLED = false — অটো-আপলোড আপাতত বন্ধ, কিছুই আপলোড হচ্ছে না।');
    process.exit(0);
  }
  try {
